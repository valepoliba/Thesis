...
path = "/home/nico/Uni/Tesi/Tesi/RDF_Clustering/outputs/tbfy/tbfy_cluster_5-1_red_o1/output_final_LCS.nt"
...
preds_dict = parse("tbfy_parameters/predicates_tl.txt")

obj_dicts = parse("tbfy_parameters/objects_tl.txt")


blank_nodes = []
with open("tbfy_parameters/blank_nodes_tl.txt", "r") as file:
    for line in file:
        ...
        for (_, p, o) in query_ans:
            ...
            if str(p) in preds_dict.keys():
                if str(o) in obj_dicts.keys():
                    ...
                    node_output["p" + str(prop_counter)] = "They all " \
                                                           + preds_dict[str(p)]\
                                                               .replace(" is", "")\
                                                               .replace(":", "")\
                                                               .replace("They", "")\
